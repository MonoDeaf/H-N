...
import { getDatabase, serverTimestamp, increment, update } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";
...
export { serverTimestamp, increment, update };
export default app;